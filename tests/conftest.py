...
# WARNING: Ensure imports from `testmanojavad` comes after this line
from testmanojavad import app, settings, db  # noqa
from testmanojavad.cli import create_user, cli  # noqa
